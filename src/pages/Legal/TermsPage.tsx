      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
          <article className="md:col-span-8 lg:col-span-9 bg-white/5 border border-white/6 rounded-xl p-8 shadow-sm">
            ...
            <section id="conduct" className="mb-6">
              ...
              <p className="text-sm leading-relaxed">
                You agree not to engage in abusive, illegal, or harmful
                behavior. Harassment, cheating, exploitation of vulnerabilities,
                or attempts to interfere with the service are prohibited.
              </p>
            </section>
            ...
            <section id="ip" className="mb-6">
              ...
              <p className="text-sm leading-relaxed">
                ...
                other intellectual property laws. You may not copy or
            ...
            <section id="termination" className="mb-6">
              ...
              <p className="text-sm leading-relaxed">
                ...
                violate these terms or disrupt the service.
              </p>
            </section>
            ...
            <section id="disclaimers" className="mb-6">
              ...
              <p className="text-sm leading-relaxed">
                ...
                maximum extent permitted by law, 42-Pasila is not liable for
