...
const GamePlayerCard = ({ cards, className = "" }: GamePlayerCardProps) => {
        ...
        {sortedCards.map((card, index) => {
          ...
          return (
            <div 
              ...
              className="relative transition-transform duration-200 hover:-translate-y-4 hover:z-[100!important]"
              style={{
